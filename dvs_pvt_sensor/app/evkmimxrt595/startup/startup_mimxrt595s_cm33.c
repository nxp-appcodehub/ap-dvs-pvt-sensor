...
WEAK void PVT0_IRQHandler(void);
//*****************************************************************************
...
void PVT0_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
//*****************************************************************************
...
void (* const g_pfnVectors[])(void) = {
    ...
    Reserved90_IRQHandler,         // 88: Reserved interrupt
    PVT0_IRQHandler,               // 89: PVT0 interrupt
}; /* End of g_pfnVectors */
